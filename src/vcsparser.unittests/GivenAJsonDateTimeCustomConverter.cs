...
namespace vcsparser.unittests
{
    public class GivenAJsonDateTimeCustomConverter
    {
        ...
        public void GivenReadJsonDateIncorrectFormatThenParserExact()
        {
            ...
            Assert.Equal("String '12:00:00 2019/04/17' was not recognized as a valid DateTime.", exception.Message);
        }
        ...
        public void GivenWriteJsonValueStringThenConvertToFormat()
        {
            ...
            Assert.StartsWith("The string 'Some String that is not in DateTimeFormat' was not recognized as a valid DateTime.", exception.Message);
        }
